_base_ = ['../configs/pvt/retinanet_pvtv2-b4_fpn_1x_coco.py']
...
load_from = 'checkpoints/retinanet_pvtv2-b4_fpn_1x_coco_20210901_170151-83795c86.pth'
seed = 42
gpu_ids = range(0, 2)
device = 'cuda'
work_dir = './log/retinanet_pvtv2'
launcher = 'pytorch'
